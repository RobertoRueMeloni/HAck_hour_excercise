class Elevator{
  ...
  buttonRequested(direction,floor){
    if(floor === this.currentFloor) return;
    if(this.requestedFloor.includes(floor)&& direction === this.direction) return;

    if (this.direction === 'still') this.floorRequest(floor);
    else{
    if(direction === this.direction){
      ...
      this.otherDirection.push(floor);
    }
  }
  }
